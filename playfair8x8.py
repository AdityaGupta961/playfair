    ...
    for i in range(len(ptlist)):
        ...
        if(p1[0]==p2[0]):  #same row
            if(p1[1]<8):
                ...
                cyphertext+=key[p1[0]][p1[1]-8]
            if(p2[1]<8):
                cyphertext+=key[p2[0]][p2[1]+1]    
            elif(p2[1]==8):
                cyphertext+=key[p2[0]][p2[1]-8]

        elif(p1[1]==p2[1]):  #same column
            if(p1[0]<8):
                cyphertext+=key[p1[0]+1][p1[1]]
            elif(p1[0]==8):
                cyphertext+=key[p1[0]-8][p1[1]]
            if(p2[0]<8):
                cyphertext+=key[p2[0]+1][p2[1]]    
            elif(p2[0]==8):
                cyphertext+=key[p2[0]-8][p2[1]]
    ...
    for i in range(len(ctlist)):
        ...
        if(p1[0]==p2[0]):  #same row
            if(p1[1]>0):
                ...
                plaintext+=key[p1[0]][p1[1]+8]
            if(p2[1]>0):
                plaintext+=key[p2[0]][p2[1]-1]    
            elif(p2[1]==0):
                plaintext+=key[p2[0]][p2[1]+8]

        elif(p1[1]==p2[1]):  #same column
            if(p1[0]>0):
                plaintext+=key[p1[0]-1][p1[1]]
            elif(p1[0]==0):
                plaintext+=key[p1[0]+8][p1[1]]
            if(p2[0]>0):
                plaintext+=key[p2[0]-1][p2[1]]    
            elif(p2[0]==0):
                plaintext+=key[p2[0]+8][p2[1]]
